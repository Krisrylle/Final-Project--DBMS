    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MySqlCommand cmd1 = new MySqlCommand("SELECT * FROM groceryshoppinglist.login WHERE Username = @UserName", registerAccount),
                cmd2 = new MySqlCommand("SELECT * FROM groceryshoppinglistform.login WHERE Email = @UserEmail", registerAccount);
                ...
                if (!(userExists))
                {
                    ...
                    string iquery = "INSERT INTO groceryshoppinglist.login(`USER_ID`,`username`,`password`,`fname`,`Lname`,`Address`) VALUES (NULL, '" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', '" + textBox5.Text + "')";
